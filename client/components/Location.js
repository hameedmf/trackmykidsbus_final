    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          <MapView.Marker
            coordinate={{
              latitude: coordinates[1].latitude || LATITUDE,
              longitude: coordinates[1].longitude || LONGITUDE
            }}
          />
          ...
          <MapView.Marker
            coordinate={{
              latitude: this.props.curLatitude || LATITUDE,
              longitude: this.props.curLongitude || LONGITUDE
            }}
            image={busMarker}
          />
        </MapView>
